...
def create_app(test_config=None):
  ...
  def add_actor(payload):
    ...
    try:
      ...
      abort(422, {'message': 'Could not post actor to databse. Insert to database failed'})
  ...
  def update_actors(payload, id):
    ...
    if actor is None:
        abort(404, {'message': 'Actor ID requested not found in the database'})
    ...
    try:
        ...
        abort(422, {'message': 'Failed to make updates to Actors database'})
  ...
  def update_movies(payload, id):
    ...
    if movie is None:
        abort(404, {'message': 'Movie ID requested not found in the database'})
    ...
    try:
        ...
        abort(422, {'message': 'Failed to make updates to movie in the database'})
